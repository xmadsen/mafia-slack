    ...
    for r in recordList:
        try:
            ...
            if action == Actions.START_GAME:
                ...
                mafiaChannels = [
                    c for c in response['channels'] if c['name'] == mafiaChannelName]
